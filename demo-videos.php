  ...
  <tr>
      <td>
        <div id="idevideo-id" style="display:none" >
          <iframe title="Using the IDE" class="youtube-player" width="660" height="397" src="https://www.youtube.com/embed/KUe_vrWbEJY?origin=http://omnest.com" style="border: 0px"></iframe>
  ...
  <tr>
      <td>
        <div id="earthvideo-id" style="display:none" >
          <iframe title="Google Earth Demo" class="youtube-player" width="660" height="397" src="https://www.youtube.com/embed/cFPJPVh3ouQ?origin=http://omnest.com" style="border: 0px"></iframe>
  ...
  <tr>
      <td>
        <div id="seqvideo-id" style="display:none" >
          <iframe title="Visualizing the Simulation on Sequence Charts" class="youtube-player" width="660" height="397" src="https://www.youtube.com/embed/9yZZFgwl4Ns?origin=http://omnest.com" style="border: 0px"></iframe>
