...
<?php include("common/top_inc.php"); ?>
	...
	<div id="header"><h1>OMNEST<sup>TM</sup> &ndash; Principles and Implementation</h1></div>

<h2>TODO: This page is currently unused, we have the white paper instead!</h2>

<p>
OMNeT++ is an object-oriented discrete network simulation
framework. The architecture is rather generic so that various problem
domains can be simulated such as protocol modeling, validation of hardware
architectures and modeling of wired and wireless communication networks.

<p>
OMNeT++ is not a simulator, but it rather provides a framework and tools to
write simulations. It is highly portable so that it can be run on the most
common operating systems such as Windows, Linux and Mac OS X. The current
version 4.0 of OMNeT++ was released in March 2009. It is free for academic
and non-profit use -- for commercial purposes OMNEST, a commercially
supported version, can be licensed by Simulcraft Inc.

<h2><a name="componentarch"></a>Component Architecture and Programming Model</h2>

One of the fundamentals of the OMNeT++ framework is the component-based
architecture for the simulation models: A model can be combined in various
ways from reusable components, so called modules. The modules can be
connected using gateways and multiple modules can be combined to form a
compound module -- the nesting depth is unlimited. The communication between
modules is done via message passing, where each message can carry arbitrary
data structures. The messages can be passed either using pre-defined paths
via gateways or directly to the destination. Each module can have
parameters to customise the module behaviour and/ or customise the topology
of the model. The modules at the lowest level of the hierarchy, also
referred to as simple modules, are programmed in C++ and make use of the
simulation library. The larger components are assembled using the
high-level language NED.

<p>
A simulation with OMNeT++ can be run utilising various interfaces: from
simple command-line interfaces, which suits ideally for batch execution, to
sophisticated graphical animated user interfaces, which can be used for
debugging or demonstration purposes. In the current version an
Eclipse-based comprehensive simulation IDE has been introduced to replace
the previous standalone GUI programs gned, scalars and plove.

<p>
OMNeT++ also supports the execution of parallel distributed simulations by
providing several communication mechanisms between partitions. To run a
parallel distributed simulation no special modifications to the models are
necessary -- only the configuration has to be modified correspondingly.

<p>
There are a couple of simulation frameworks that enable OMNeT++ to be used
for wireless sensor networks. The most common of these frameworks are
...
<p style="background-color:#e8e8e8; padding-left:10px; padding-right: 10px; font-size:13px">
OMNEST is a high-performance, versatile <b>discrete event simulation framework</b>. Its primary
...
<h2><a name="ide"></a>The Simulation IDE</h2>
...
results. It also supports visualizing simulation execution traces as
sequence charts, and generating documentation.</p>
...
<img src="images/ide-overview/img2.png" align="right"/>
<img src="images/ide-overview/img4.png" align="right"/>
<img src="images/ide-overview/img6.png" align="right"/>
<img src="images/ide-overview/img16.png" align="right"/>
<img src="images/ide-overview/img20.png" align="right"/>
<img src="images/ide-overview/img21.png" align="right"/>
<img src="images/ide-overview/img22.png" align="right"/>
  ...
  <div class="figure">
    ...
    <div class="figure-contents">
      <div class="screenshot">
        ...
        "images/ide-overview/img1.png" alt=
...
<div class="sect1" lang="en">
  ...
  <div class="figure">
    ...
    <div class="figure-contents">
      <div class="screenshot">
        <div class="mediaobject" align="center"><img src=
        "images/ide-overview/img2.png" alt=
  ...
  <div class="figure">
    ...
    <div class="figure-contents">
      <div class="screenshot">
        <div class="mediaobject" align="center"><img src=
        "images/ide-overview/img3.png" alt="Properties view"
        align="middle"></div>
      </div>
    </div>
  </div><br class="figure-break">
  ...
  <div class="figure">
    ...
    <div class="figure-contents">
      <div class="screenshot">
        <div class="mediaobject" align="center"><img src=
        "images/ide-overview/img4.png" alt=
  ...
  <div class="figure">
    ...
    <div class="figure-contents">
      <div class="screenshot">
        <div class="mediaobject" align="center"><img src=
        "images/ide-overview/img5.png" alt="Outline View" align=
        "middle"></div>
      </div>
    </div>
  </div><br class="figure-break">
...
<div class="sect1" lang="en">
  ...
  <div class="figure">
    ...
    <div class="figure-contents">
      <div class="screenshot">
        <div class="mediaobject" align="center"><img src=
        "images/ide-overview/img6.png" alt=
  ...
  <div class="figure">
    ...
    <div class="figure-contents">
      <div class="screenshot">
        <div class="mediaobject" align="center"><img src=
        "images/ide-overview/img7.png" alt=
  ...
  <div class="figure">
    ...
    <div class="figure-contents">
      <div class="screenshot">
        <div class="mediaobject" align="center"><img src=
        "images/ide-overview/img8.png" alt=
  ...
  <div class="figure">
    ...
    <div class="figure-contents">
      <div class="screenshot">
        <div class="mediaobject" align="center"><img src=
        "images/ide-overview/img9.png" alt=
  ...
  <div class="figure">
    ...
    <div class="figure-contents">
      <div class="screenshot">
        <div class="mediaobject" align="center"><img src=
        "images/ide-overview/img10.png" alt=
  ...
  <div class="figure">
    ...
    <div class="figure-contents">
      <div class="screenshot">
        <div class="mediaobject" align="center"><img src=
        "images/ide-overview/img11.png" alt="The Problems View"
        align="middle"></div>
      </div>
    </div>
  </div><br class="figure-break">
...
<div class="sect1" lang="en">
  ...
  <div class="figure">
    ...
    <div class="figure-contents">
      <div class="screenshot">
        <div class="mediaobject" align="center"><img src=
        "images/ide-overview/img12.png" alt=
  ...
  <div class="figure">
    ...
    <div class="figure-contents">
      <div class="screenshot">
        <div class="mediaobject" align="center"><img src=
        "images/ide-overview/img13.png" alt="Progress View"
        align="middle"></div>
      </div>
    </div>
  </div><br class="figure-break">
  ...
  <div class="figure">
    ...
    <div class="figure-contents">
      <div class="screenshot">
        <div class="mediaobject" align="center"><img src=
        "images/ide-overview/img14.png" alt="Console View"
        align="middle"></div>
      </div>
    </div>
  </div><br class="figure-break">
  ...
  <div class="figure">
    ...
    <div class="figure-contents">
      <div class="screenshot">
        <div class="mediaobject" align="center"><img src=
        "images/ide-overview/img15.png" alt=
...
<div class="sect1" lang="en">
  ...
  <div class="figure">
    ...
    <div class="figure-contents">
      <div class="screenshot">
        <div class="mediaobject" align="center"><img src=
        "images/ide-overview/img16.png" alt=
  ...
  <div class="figure">
    ...
    <div class="figure-contents">
      <div class="screenshot">
        <div class="mediaobject" align="center"><img src=
        "images/ide-overview/img17.png" alt="The Event Log View"
        align="middle"></div>
      </div>
    </div>
  </div><br class="figure-break">
...
<div class="sect1" lang="en">
  ...
  stored in vector files. Bar charts are created from scalar results and histograms.
