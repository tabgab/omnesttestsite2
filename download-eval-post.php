...
if(eregi("^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$", $email))
{
    ...
    {
        include("download-eval-datasent.php");
    } else {
...
<?php include("common/top_inc.php"); ?>
	...
	<!-- Start Content -->
	<div id="content">
	  <div id="header"><h1>Error</h1></div>Please press the back button on your browser and provide a valid email address so that we can contact you if necessary.<br><br>
	</div>
	<!-- End Content -->
	<!-- Start Right -->
