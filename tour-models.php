...
<img class="pic right rounded" width=200 src="images/tour/models.png" alt="todo" onclick="enlarge(this);"/>
<h1>Simulation models are available for many network simulation domains</h1>
<p>
Internet &bull;
...
<img class="pic left rounded" width=200 src="images/tour/combine.png" alt="todo" onclick="enlarge(this);"/>
...
can be combined in unexpected ways (because components do not interact with each other directly
on the C++ level, only via means provided by OMNEST, e.g. messages).
</p>
<div style="clear:both"></div>

<img class="pic right rounded" width=200 src="images/tour/code.png" alt="todo" onclick="enlarge(this);"/>
...
<img class="pic left rounded" width=200 src="images/tour/collaborate.png" alt="todo" onclick="enlarge(this);"/>
