...
<img class="pic left rounded" width=200 src="images/tour/ide-tools.png" alt="todo" onclick="enlarge(this);"/>
...
This feature helps reducing debugging time, and is also useful when demonstrating the model to 3rd parties.
