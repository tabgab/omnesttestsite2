...
<div id="header"><h1>What's New in OMNEST 5.2.1</h1></div>

<div id="content">

<div class="paragraph"><p>Highlights of this release are the fine-tuning of result recording and processing
  ...
  several related changes in the IDE.</p></div>
  ...
  The OSG viewer was factored out from Qtenv into a separate support library
     which is only loaded at runtime on demand. Core OMNEST no longer has
  ...
  <li>
  <p>
  Refinements on the build process of OMNEST itself: generated files are
  ...
  <li>
  <p>
  The samples/ folder is now optional: deleting it in an OMNEST installation
     will no longer break the build.
  </p>
  </li>
  </ul></div>
  <div class="paragraph"><p>IDE/Base:</p></div>
  <div class="ulist"><ul>
  <li>
  <p>
  ...
  <div class="paragraph"><p>IDE/Build:</p></div>
  <div class="ulist"><ul>
  <li>
  <p>
  ...
  <div class="paragraph"><p>IDE/Launching:</p></div>
  <div class="ulist"><ul>
  <li>
  <p>
  ...
  <div class="paragraph"><p>Envir:</p></div>
  <div class="ulist"><ul>
  <li>
  <p>
  ...
  <div class="paragraph"><p>Scavetool:</p></div>
  <div class="ulist"><ul>
  <li>
  <p>
  ...
  <div class="paragraph"><p>Result recording and processing:</p></div>
  <div class="ulist"><ul>
  <li>
  <p>
  Switch to new scalar/vector file recorders: The default values for
     ...
     still exist. They will be removed in a later version of OMNEST.
  </p>
  </li>
  <li>
  <p>
  ...
  <div class="paragraph"><p>Bugs fixed: see <a href="http://dev.omnetpp.org/bugs/changelog_page.php?project_id=1">http://dev.omnetpp.org/bugs/changelog_page.php?project_id=1</a></p></div>
  </div>

<br/>
<h2><a href="whatsnew-511.php">What's New in OMNEST 5.1.1 <img src="common/images/button_next.png"><img src="common/images/button_next.png"></a></h2>
