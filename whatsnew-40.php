...
<head>
    ...
    <title>OMNEST - What's new in OMNEST 4.0?</title>
...
<h2>Tooling</h2>
  ...
  or found useful with OMNEST, such as gdb, perl, libxml, gmp, graphviz,
...
<h2>Build system</h2>
  ...
  process go in a separate directory tree (out/).</p>
  ...
  there is no need to modify configure.user.</p>

<h2>Simulation kernel</h2>
  ...
  packing several boolean variables into an unsigned int).</p>
  ...
  adjustments) in the source code.</p>
  ...
  the animation of wireless transmissions later.</p>
...
<h2>NED</h2>
  ...
  tool is provided to convert old NED files to the new syntax.</p>
  ...
  ned.DelayChannel and ned.DatarateChannel.</p>
  ...
  new submodules and connections.</p>

  <p>
  Inner types are now supported. This is most useful for making channel
  definitions local to the network definition that uses them.</p>
  ...
  inout gates appear as (input,output) gate pairs.</p>
  ...
  the default values get used automatically.</p>

  <p>
  Support for arithmetic expressions has become more complete, e.g. string
  manipulation is also possible.</p>
  ...
  which can be modified via inhertance.</p>
...
<h2>Ini files</h2>
  ...
  overriding the values specified in the ini file.</p>
  ...
  different trajectory after a supposedly "harmless" code change.</p>
...
<h2>Result analysis</h2>
  ...
  the simulation or the whole experiment.</p>
