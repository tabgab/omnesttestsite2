<?php
//
// News items -- id, title, date, summary, fulltext, etc.
// Add new items at the top! Ordering must be newest-to-oldest.
//
$news = array(
    array(
        "id" => "omnest-6.0.3",
        ...
        "date" => "March 18, 2024",
        "summary" => "OMNEST 6.0.3 is a maintenance release containing several bugfixes.",
        "link" => "whatsnew-603"
    ),
    ...
    array(
        ...
        ",
        "fulltext" => "
          <p>The <a href='http://www.omnet-workshop.org/2013' target='_blank'>workshop</a>
          drew a great crowd of academics and professionals to the French Riviera.
          They presented results of their research, including new ideas and contributions
          to open-source simulation models.</p>
          <p>As in the previous years, presentations have been selected from
          ...
          proceedings and the ACM Digital Library.</p>
        ",
    ),
    ...
    array(
        ...
        "date" => "April 6, 2010",
        "summary" => "
          The 3rd International Workshop on OMNeT++ was held on March 19, 2010 in
        ...
        "fulltext" => "
          ...
          slides, can be read on the
          <a href='http://www.omnet-workshop.org/2010' target='_blank'>workshop web site</a>.
          </p>

          <p>Five papers have been published as regular papers with an oral
          ...
          slot of 15 minutes. We also had the possibility to discuss community
